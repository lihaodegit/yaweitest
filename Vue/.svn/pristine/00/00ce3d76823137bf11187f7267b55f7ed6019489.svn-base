<template>
	  <div>
	    ...
	    <el-row style="min-height:300px;border-radius: 8px;">
	      ...
	      <el-button v-show="dataForm.applystatus == '11'" type="primary" style="margin-left: 30%;margin-top: 30px;width: 140px;" @click="beforeCommit('13')">确认付款</el-button>
	     <!-- <el-button v-show="dataForm.applystatus == '9'" type="primary" style="width: 140px;" @click="beforeCommit('12')">驳回</el-button> -->
	    <el-dialog
	    title=""
       ...
       init (id,baseid) {
       	...
       	this.$nextTick(() => {
			...
			beforeCommit (status){
				...
				if(status == "13"){
					this.dataForm.dialogTitle = "确认付款备注"
				}
