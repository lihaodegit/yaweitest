        ...
        label="车辆基础信息表主键">
			...
			<el-table-column
				...
				<template slot-scope="scope">
					<el-tag v-if="scope.row.applystatus=='9'" size="small" type="success">市科技局复审通过</el-tag>
				</template>
			</el-table-column>
    <!--  <el-table-column
        prop="boardtime"
...
<script>
	import detail from './cityfinanceFs-detail'
  export default {
    data () {
      return {
        dataForm: {
      ...
      addOrUpdateHandle (id) {
        ...
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id)
			...
			//详情
			detail (id,baseid) {
				 this.$router.push({path:'/cityfinanceFs-detail',name:"cityfinanceFs-detail",params: {  baseid: baseid,id:id}});
