    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
		  ...
		  <el-tag v-else-if="scope.row.applystatus == '15'" size="medium" type="danger">市科技局确认驳回</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        fixed="right"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        console.log(params)
        this.$http({
          url: this.$http.adornUrl('/generator/devcarbasedata/carApplyProgressList'),
          method: 'get',
      ...
      detailHandle (id,baseid) {
        this.$router.push({path:'/devcarprogress-detail',name:"devcarprogress-detail",params: {  baseid: baseid,id:id}});
      }
    }
  }
</script>
