      ...
      <el-table-column
        ...
        label="车辆基础信息表主键">
			...
			<el-table-column
				...
				<el-tag v-if="scope.row.applystatus=='5'" size="small" type="success">市财政局审核通过</el-tag>
				</template>
			</el-table-column>
    <!--  <el-table-column
        prop="boardtime"
...
<script>
	import detail from './areafinanceDb-detail'
  export default {
    data () {
      return {
        dataForm: {
      ...
      addOrUpdateHandle (id) {
        ...
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id)
			...
			//详情
			detail (id,baseid) {
				 this.$router.push({path:'/areafinanceDb-detail',name:"areafinanceDb-detail",params: {  baseid: baseid,id:id}});
