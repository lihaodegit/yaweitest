  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        console.log(params)
        this.$http({
          url: this.$http.adornUrl('/cityfinance/devapply/cityFinanceApplyProgressList'),
          method: 'get',
      ...
      detailHandle (id,baseid) {
        this.$router.push({path:'/cityFinanceProgress-detail',name:"cityFinanceProgress-detail",params: {  baseid: baseid,id:id}});
      }
    }
  }
</script>
