    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.auditresult!='1'&&scope.row.auditresult!='0'" type="text" size="small" @click="passHandle(scope.row.id)">通过</el-button>
		  <el-button v-if="scope.row.auditresult!='1'&&scope.row.auditresult!='0'" type="text" size="small" @click="rejectHandle(scope.row.id)">驳回</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
  ...
  export default {
    ...
    methods: {
	  ...
	  closeDlg(){
		...
		//提交
		this.$http({
			url: this.$http.adornUrl('/technology/audit/carqualifireject'),
			method: 'post',
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/technology/audit/carqualifilist'),
          method: 'get',
      ...
      passHandle (id) {		
		...
		*/
        ...
        this.$confirm(`确定通过当前企业申请?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/technology/audit/carqualifipass'),
            method: 'post',
            data: this.$http.adornData(ids, false)
          }).then(({data}) => {
            if (data && data.code === 0) {
