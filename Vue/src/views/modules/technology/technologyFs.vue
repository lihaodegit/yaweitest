        ...
        label="车辆基础信息表主键">
			...
			<el-table-column
				...
				<template slot-scope="scope">
					<el-tag v-if="scope.row.applystatus=='3'" size="small" type="success">市公安局初审通过</el-tag>
					<el-tag v-if="scope.row.applystatus=='7'" size="small" type="success">区财政局初审通过</el-tag>
				</template>
			</el-table-column>
    <!--  <el-table-column
        prop="boardtime"
