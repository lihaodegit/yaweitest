<template>
  <el-dialog
    ...
    <el-form-item label="车辆领域 1个人 2单位" prop="carfield">
      <el-input v-model="dataForm.carfield" placeholder="车辆领域 1个人 2单位"></el-input>
    </el-form-item>
    <el-form-item label="0发起申请" prop="applystatus">
      <el-input v-model="dataForm.applystatus" placeholder="0发起申请"></el-input>
    </el-form-item>
    ...
    <el-form-item label="所属区域" prop="ylzd1">
      <el-input v-model="dataForm.ylzd1" placeholder="所属区域"></el-input>
    </el-form-item>
    <el-form-item label="所属车企" prop="ylzd2">
      <el-input v-model="dataForm.ylzd2" placeholder="所属车企"></el-input>
    </el-form-item>
    <el-form-item label="市区财政局是否可看  0 不可看 1可看" prop="ylzd3">
      <el-input v-model="dataForm.ylzd3" placeholder="市区财政局是否可看  0 不可看 1可看"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          carfield: [
            { required: true, message: '车辆领域 1个人 2单位不能为空', trigger: 'blur' }
          ],
          applystatus: [
            { required: true, message: '0发起申请', trigger: 'blur' }
          ],
          applytime: [
          ...
          ylzd2: [
            { required: true, message: '所属车企不能为空', trigger: 'blur' }
          ],
          ylzd3: [
            { required: true, message: '市区财政局是否可看  0 不可看 1可看不能为空', trigger: 'blur' }
          ],
          ylzd4: [
    ...
    methods: {
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.ylzd5 = data.devapply.ylzd5
						...
						this.$http({
							url: this.$http.adornUrl('/technologyDb/devapply/list'),
							method: 'get',
							params: this.$http.adornParams({
								'page': this.pageIndex,
								'limit': this.pageSize,
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/technologyDb/devapply/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
