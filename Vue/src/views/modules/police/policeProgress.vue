  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        console.log(params);
        this.$http({
          url: this.$http.adornUrl('/police/devapply/policeApplyProgressList'),
          method: 'get',
      ...
      detailHandle (id,baseid) {
        this.$router.push({path:'/policeProgress-detail',name:"policeProgress-detail",params: {  baseid: baseid,id:id}});
      }
    }
  }
</script>
