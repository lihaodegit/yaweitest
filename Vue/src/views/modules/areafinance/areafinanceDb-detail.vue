<template>
	  <div>
	    ...
	    <el-row style="min-height:300px;border-radius: 8px;">
	      ...
	      <el-button v-show="dataForm.applystatus == '5'" type="primary" style="margin-left: 30%;margin-top: 30px;width: 140px;" @click="beforeCommit('7X')">通过</el-button>
	      <el-button v-show="dataForm.applystatus == '5'" type="primary" style="width: 140px;" @click="beforeCommit('8')">驳回</el-button>
	    <el-dialog
	    title=""
